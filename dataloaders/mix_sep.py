...
from utils.data_tools import joints_list
...
class CustomDataset(Dataset):
    def __init__(self, args, loader_type, augmentation=None, kwargs=None, build_cache=True):
        ...
        self.norm = True
        self.mean = np.load('./mean_std/beat2_2_330_mean.npy')
        self.std = np.load('./mean_std/beat2_2_330_std.npy')
        self.trans_mean = np.load('./mean_std/beat2_2_trans_mean.npy')
        self.trans_std = np.load('./mean_std/beat2_2_trans_std.npy')
